...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      locale: "en_NG",
      images: [{ url: new URL("/og-image.jpg", metadataBase).toString(), width: 1736, height: 906, alt: "Volta Spark cleaning services in Lagos" }],
    },
    twitter: { card: "summary_large_image", title, description, images: [new URL("/og-image.jpg", metadataBase).toString()] },
  };
}
